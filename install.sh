...
catkill otp "$HOME/bin/otp"
chmod a+x "$HOME/bin/otp"
catkill t "$HOME/bin/t"
chmod a+x "$HOME/bin/t"
catkill ta "$HOME/bin/ta"
chmod a+x "$HOME/bin/ta"
catkill td "$HOME/bin/td"
chmod a+x "$HOME/bin/td"
catkill tm "$HOME/bin/tm"
chmod a+x "$HOME/bin/tm"
...
catkill pathogen.vim "$HOME/.vim/autoload/pathogen.vim"
