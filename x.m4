...
makewin()
{
  case $@ in
    ...
    CASEHOST(anglewing, anglewing.infospheres.com., LightSteelBlue, black)
    CASEHOST(moth, moth.infospheres.com., LightSteelBlue, black)
    CASEHOST(queen, queen.infospheres.com., LightSteelBlue, black)
    CASEHOST(buckeye, buckeye.infospheres.com., LightSteelBlue, black)
    CASEHOST(crescent, crescent.infospheres.com., LightSteelBlue, black)
    CASEHOST(fritillary, fritillary.infospheres.com., LightSteelBlue, black)
    CASEHOST(checkerspot, checkerspot.infospheres.com., LightSteelBlue, black)
    CASEHOST(lady, lady.infospheres.com., LightSteelBlue, black)
    CASEHOST(viceroy, viceroy.infospheres.com., LightSteelBlue, black)
    CASEHOST(admiral, admiral.infospheres.com., LightSteelBlue, black)
    CASEHOST(nymph, nymph.infospheres.com., LightSteelBlue, black)
    CASEHOST(satyr, satyr.infospheres.com., LightSteelBlue, black)
    CASEHOST(blue, blue.infospheres.com., LightSteelBlue, black)
    CASEHOST(copper, copper.infospheres.com., LightSteelBlue, black)
    CASEHOST(snout, snout.infospheres.com., LightSteelBlue, black)
    CASEHOST(white, white.infospheres.com., LightSteelBlue, black)
    CASEHOST(alfalfa, alfalfa.infospheres.com., LightSteelBlue, black)
    CASEHOST(sulphur, sulphur.infospheres.com., LightSteelBlue, black)
    CASEHOST(parnassian, parnassian.infospheres.com., LightSteelBlue, black)
    CASEHOST(skippers, skippers.infospheres.com., LightSteelBlue, black)
